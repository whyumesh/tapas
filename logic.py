...
def route_based_on_classification(transcribed_text, video_file, selected_lines):
    prompt = f"""
    1. **Explanation of the Error**: Analyze the video '{video_file}' and the spoken issue '{transcribed_text}' to identify the specific problem in the code lines '{selected_lines}'. Clearly explain the cause of the error, look at every possible error in the code like syntax/indentation etcetra.
